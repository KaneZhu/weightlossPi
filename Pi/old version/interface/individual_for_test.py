...
code='0'
img = cv2.imread("83.jpg",0) #change grey
...
cv2.namedWindow("diff result2")
cv2.imshow("diff result2",img2)
...
# print 'name: ',name,'energy: ',energy,'fat: ',fat,'sugars: ',sugars,'salt: ',salt
cv2.waitKey(0)
